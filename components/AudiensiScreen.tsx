                  ...
                  <div className="p-4 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-primary/50 transition-all shadow-sm">
                    <div className="flex items-center gap-4 group">
                      <div className="relative size-6 shrink-0 z-10">
                        <input
                          type="checkbox"
                          id="is_new_application_audiensi"
                        ...
                        />
                        <div className="absolute inset-0 size-6 rounded-lg border-2 border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-900 group-hover:border-primary transition-all peer-checked:bg-primary peer-checked:border-primary flex items-center justify-center pointer-events-none z-10">
                      ...
                      <label htmlFor="is_new_application_audiensi" className="flex flex-col cursor-pointer select-none flex-1">
